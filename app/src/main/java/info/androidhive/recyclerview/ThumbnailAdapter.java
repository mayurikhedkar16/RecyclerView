...
public class ThumbnailAdapter extends RecyclerView.Adapter<ThumbnailAdapter.MyViewHolder> {
    ...
    private List<Thumbnail_POJO> moviesList;
    Typeface font;
    Context mContext;
...
//            });
    ...
    public ThumbnailAdapter(List<Thumbnail_POJO> moviesList, Context mContext, FragmentManager fragmentManager) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Thumbnail_POJO thumbnailPOJO = moviesList.get(position);
